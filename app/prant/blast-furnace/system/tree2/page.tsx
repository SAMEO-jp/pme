...
export const metadata: Metadata = {
  title: "高炉設備体系図（横展開） | 設備管理アプリ",
  description: "高炉の設備体系を横方向のツリー構造で表示するページ",
}
    ...
    .map(([twoDigits, items]) => {
      ...
      const children = Object.entries(groupedByThreeDigits)
        .map(([threeDigits, subItems]) => {
          ...
          // 4桁製番を抽出
          const fourDigitItems = subItems.filter(item => 
            item.B_id.length === 4 && !item.B_id.endsWith('0')
          );
          ...
          const groupedByFourDigits = fourDigitItems.map(fourDigitItem => {
            ...
            const children = detailedItems
              .filter(item => item.B_id.startsWith(prefix))
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      <div className="p-6 w-full">
        {/* ヘッダー */}
        <div className="mb-8 pt-8 max-w-5xl mx-auto">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-500 dark:text-gray-400">/</span>
                    <h1 className="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-yellow-600 dark:from-orange-400 dark:to-yellow-500">横展開表示</h1>
                  </div>
                  <p className="text-slate-600 dark:text-slate-300 mt-2">高炉設備の体系を横方向のツリー構造で表示します。階層関係を視覚的に確認できます。</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-12 max-w-5xl mx-auto">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
            ...
            <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
              <p>
                設備体系ツリーは、設備の階層関係を横方向に展開して表示します：
              </p>
