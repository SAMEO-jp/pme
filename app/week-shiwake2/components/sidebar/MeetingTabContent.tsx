...
export function MeetingTabContent() {
  ...
  return (
    <div className="p-4">
      <h2 className="text-lg font-bold mb-4">会議</h2>
      <div className="mb-4 space-x-2">
        ...
        <button onClick={handleAddEvent} className="bg-blue-500 text-white px-2 py-1 rounded">追加</button>
      </div>
    </div>
  );
} 